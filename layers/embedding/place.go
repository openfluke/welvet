...
// Place binds this Embedding layer onto the volumetric grid at (z,y,x,l).
func Place(g *architecture.Grid, z, y, x, lidx int, layer *Layer) error {
	if g == nil || layer == nil {
		return fmt.Errorf("embedding: Place nil grid/layer")
	}
	layer.Core.Type = core.LayerEmbedding
