...
// Freeze) and optional per-hemisphere BranchModes / per-child ChildModes.
//
...
// Train / TrainStack / TrainStackMSE / TrainStackCE drive updates. Freeze BranchModes
// still forward and combine but skip weight updates (and CamSync skips frozen cams).
