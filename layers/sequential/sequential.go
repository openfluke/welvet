...
// Layer is Sequential compose of Dense children, or mixed Ops
// (Dense, SwiGLU, RMSNorm, LayerNorm) via NewFromOps. Parallel/Stack
// nesting is parallel.Stack (import cycle).
type Layer struct {
	Core     core.Layer
	Cfg      Config
