...
// explicit Grid rows×cols). Variants: Gumbel (non-deterministic), Masked,
// Sparsemax, Entmax-α, Hierarchical. Temperature scales logits; backward
// uses softmax Jacobian × (1/T).
//
