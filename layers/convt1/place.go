...
// Place binds this ConvT1 layer onto the volumetric grid at (z,y,x,l).
func Place(g *architecture.Grid, z, y, x, lidx int, layer *Layer) error {
	if g == nil || layer == nil {
		return fmt.Errorf("convt1: Place nil grid/layer")
	}
	layer.Core.Type = core.LayerConvTransposed1D
