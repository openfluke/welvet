...
// ShaderDenseExt — FormatNone remaining dtypes decoded on device (no host f32 stage).
// kind:
//
//	0 Uint4 affine (min@byte0 + nibbles@4)
//	1 Uint2 affine (min@0 + 2bit@4)
//	2 NF4 (nibbles@0 * scale)
//	3 signed N-bit (bits in params.bits, scale)
//	4 unsigned N-bit affine (min@0 + bits@4)
//	5 Int16 * scale
//	6 Int32 * scale
//	7 Int64 * scale
//	8 Uint16 affine
//	9 Uint32 affine
//	10 Uint64 affine
//	11 Float64 (narrow to f32 MAC)
//	12 Complex64 real
//	13 Complex128 real
const ShaderDenseExt = `
struct Params {
